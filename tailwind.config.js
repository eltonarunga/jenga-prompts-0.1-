...
export default {
  ...
  theme: {
    extend: {
      // Custom color palette for JengaPrompts Pro
      colors: {
      ...
      backgroundImage: {
        ...
        'gradient-surface': 'linear-gradient(145deg, #f8fafc 0%, #e2e8f0 100%)',
  ...
  safelist: [
    ...
    'bg-blue-500',
    {
      pattern: /^(bg|text|border)-(primary|secondary|success|warning|error)-(50|100|200|300|400|500|600|700|800|900)$/,
    },
  ],
}